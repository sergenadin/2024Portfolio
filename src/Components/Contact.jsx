  ...
  return (
    <div id="Contact" className="pt-5">
      ...
      >
        ...
        <p>
          {" "}
          Feel free to reach out for inquiries, collaboration, or just to say
          hello{" "}
        </p>
        <div className="container textlightbrand">
          <Row
            lg={2}
            xs={1}
            className="text-start p-2 d-flex align-items-start"
          >
              ...
              <div className="social-links">
                <div className="networks">
                  <div className="netbox">
                    <NavLink
                      to={
                        "https://www.google.com/maps/place/Serge+Nadin,+City+Rabat,+Haynada+1+Rue+57"
                      }
                      target="_blank"
                    ...
                    <NavLink
                      to={
                        "https://www.instagram.com/mark_frost333?utm_source=qr&igsh=ZDExYjZkNGI0OA=="
                      }
                      target="_blank"
                      className="icon BtnCardProject2 fw-bold fs-3"
                      data-tip="Network 1"
                    ...
                    <NavLink
                      to={
                        "https://www.linkedin.com/in/ets-petcha-freres-a854b5253/"
                      }
                      target="_blank"
                      className="icon BtnCardProject2 fw-bold fs-3"
                      data-tip="Network 1"
                    ...
                    <NavLink
                      to={
                        "https://www.facebook.com/serge.nadin?mibextid=ZbWKwL"
                      }
                      target="_blank"
                      className="icon BtnCardProject2 fw-bold fs-3"
                      data-tip="Network 1"
